  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden flex items-center justify-center py-16 md:py-24">
      ...
      <div className="absolute inset-0 pointer-events-none select-none">
        <span className="doodle-bg-text top-10 -left-12 rotate-12">JOIN</span>
        <span className="doodle-bg-text bottom-10 -right-12 -rotate-12">CREATE</span>
      </div>
        ...
        <div className="bg-surface-container rounded-2xl border-2 border-primary/30 p-8 md:p-10 shadow-hard space-y-8 relative">
          <div className="text-center space-y-3">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="font-label text-label-sm text-primary tracking-[0.2em] uppercase">New Member</span>
            </div>
            <h1 className="font-display text-headline-lg leading-tight">
              <span className="doodle-underline">JOIN THE CLUB</span>
            </h1>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <label className="block font-label text-label-sm text-on-surface/70 mb-1.5 tracking-wider uppercase">Name</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="block font-label text-label-sm text-on-surface/70 mb-1.5 tracking-wider uppercase">Confirm Password</label>
              <div className="relative">
                <input
